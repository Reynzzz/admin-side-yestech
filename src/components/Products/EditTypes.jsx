...
import { updateCategoryProducts, updateCategoryYestech, updateTypes } from "../../stores/actionCreator";
import { toast } from "react-toastify";
export default function EditTypes({categoryId,category}) {
  ...
  async function handleSubmit(e) {
    try {
      e.preventDefault()
      await dispatch(updateTypes(formData,categoryId))
