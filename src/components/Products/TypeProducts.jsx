...
import { deleteCategoryProducts, deleteCategoryYestech, deleteTypes, fetchCategoryProducts, fetchCategoryYestechOwner, fetchTypes } from "../../stores/actionCreator";
                  ...
                  <tr className="hover" key={el.id}>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex justify-end space-x-2">
                        ...
                        <EditTypes categoryId={el.id} category={el} />
                      </div>
                    </td>
                  </tr>
                ))
