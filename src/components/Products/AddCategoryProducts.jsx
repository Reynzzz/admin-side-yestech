...
import { postCategoryProducts, postCategoryYestech } from '../../stores/actionCreator';
import { toast } from 'react-toastify';

export default function AddCategoryProducts() {
  ...
  async function handleSubmit(e) {
    e.preventDefault();
    try {
      await dispatch(postCategoryProducts(data));
