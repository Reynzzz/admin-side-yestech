...
import { deleteCategoryProducts, deleteCategoryYestech, fetchCategoryProducts, fetchCategoryYestechOwner } from "../../stores/actionCreator";
...
export default function CategoryProducts() {
  ...
  async function handleDelete(id) {
    try {
      await dispatch(deleteCategoryProducts(id))
                  ...
                  <tr className="hover" key={el.id}>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex justify-end space-x-2">
                        ...
                        <EditCategoryProducts categoryId={el.id} category={el} />
                      </div>
                    </td>
                  </tr>
                ))
