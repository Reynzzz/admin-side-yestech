...
import { updateCategoryProducts, updateCategoryYestech } from "../../stores/actionCreator";
import { toast } from "react-toastify";
export default function EditCategoryProducts({categoryId,category}) {
  ...
  async function handleSubmit(e) {
    try {
      e.preventDefault()
      await dispatch(updateCategoryProducts(formData,categoryId))
